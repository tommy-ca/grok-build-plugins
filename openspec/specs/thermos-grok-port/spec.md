# thermos-grok-port Specification

## Purpose
Catalog sibling thermos ports upstream dual-rubric review to Grok Build with spawn_subagent harness, poteto bind, and lever VERIFY.
