# openspec-tasks-parallel-bands Specification

## Purpose
Intent-driven tasks template exposes Parallel bands for concurrent work and serial gates for true gates only; openspec-intent-flow and SPEC scenarios narrate N-briefs execution across exclusive worktrees without inventing Drove max_concurrent quotas.
