...
grok --sandbox off plugin enable thermos
```

Spawn `agent-compatibility:startup-review`, not `startup-review`. Spawn `thermos:thermo-nuclear-review-subagent` / `thermos:thermo-nuclear-code-quality-review-subagent`, not bare thermo-nuclear stems. Start a new session after enable.
